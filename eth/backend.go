...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	var (
		...
		cacheConfig = &core.CacheConfig{Disabled: config.NoPruning, TrieCleanLimit: config.TrieCleanCache, TrieDirtyLimit: config.TrieDirtyCache, TrieTimeLimit: config.TrieTimeout, TrieFlushPeriodLimit: config.TrieFlushPeriod}
	)
